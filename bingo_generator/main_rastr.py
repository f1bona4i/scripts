...
elements = [
    ...
    "изучать астрологию, знаки зодиака, смотреть шоу, связанные с этой темой", "учиться в мгу на физфаке", "разработка собственного кода и программного обеспечения", "смотреть реалити-шоу или уральских пельменей", "покупать подписки на стримеров/ мерч у блогеров",
...
font_path = "ofont.ru_Oldtimer.ttf"
